...
resource_group_name = "rg-utpdavid2026-user7-cc"
location            = "eastus2"

##### Variables - Storage Account RAC #####
storage_account_name  = "stgarelyschiriqui"
container_name        = "container-utp"
container_access_type = "private" #

##### Variables - Key Vault del RAC #####
key_vault_name = "key-arelys-utp"
key_vault_sku  = "standard" # ejemplo: "standard"


##### Variables - Azure AI Services (Cognitive) #####
ai_services_name                  = "ai-services-arelys-utp"
ai_services_custom_subdomain_name = "ai-arelys-utp"
...
ai_foundry_hub_name     = "foundry-arelys-utp"
ai_foundry_project_name = "projects-arelys-utp"
